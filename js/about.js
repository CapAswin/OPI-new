window.OpulentSite.init({
    ...
    translations: {
        en: {
            ...
            aboutEcoTagStrategicIntegration: 'Strategic Integration',
            aboutEcoTagBrandPower: 'Brand Power',
            aboutEcoBadgeActive: 'Active',
            aboutEcoInfluencerPoint1: 'Talent Acquisition',
            aboutEcoInfluencerPoint2: 'Audience Monetization',
            ...
            aboutStrategyMethodology: 'Methodology',
            aboutStrategyTitle: 'Investment Model',
            aboutStrategyText:
                'Our disciplined allocation strategy balances immediate opportunity with institutional-grade risk mitigation.',
            aboutStrategyActiveTitle: 'Actively Invested',
            aboutStrategyActiveText: 'Deployed in high-yield institutional vehicles',
            aboutStrategyReserveTitle: 'Reserve Capital',
            aboutStrategyReserveText: 'Liquid assets for opportunistic acquisitions',
            aboutStrategyTargetRange: 'Target Range',
            aboutStrategyNote:
                'Allocation is reviewed quarterly by the Strategy Committee to ensure alignment with macroeconomic shifts and emerging sector volatility.',
            aboutStrategyMeetTeam: 'Meet the Team Behind the Strategy',
        ...
        ar: {
            ...
            aboutEcoTagStrategicIntegration: 'تكامل استراتيجي',
            aboutEcoTagBrandPower: 'قوة العلامة',
            aboutEcoBadgeActive: 'نشط',
            aboutEcoInfluencerPoint1: 'استقطاب المواهب',
            aboutEcoInfluencerPoint2: 'تحقيق الدخل من الجمهور',
            ...
            aboutStrategyMethodology: 'المنهجية',
            aboutStrategyTitle: 'نموذج الاستثمار',
            aboutStrategyText:
                'توازن استراتيجيتنا المنضبطة لتخصيص الأصول بين الفرص الفورية وتخفيف المخاطر بمعايير مؤسسية.',
            aboutStrategyActiveTitle: 'رأس مال مُستثمر',
            aboutStrategyActiveText: 'مُوظَّف في أدوات مؤسسية عالية العائد',
            aboutStrategyReserveTitle: 'رأس مال احتياطي',
            aboutStrategyReserveText: 'أصول سائلة لاقتناص فرص الاستحواذ',
            aboutStrategyTargetRange: 'النطاق المستهدف',
            aboutStrategyNote:
                'تُراجع عملية التخصيص ربعياً من قبل لجنة الاستراتيجية لضمان المواءمة مع التحولات الكلية وتقلبات القطاعات الناشئة.',
            aboutStrategyMeetTeam: 'تعرّف على الفريق خلف الاستراتيجية',
